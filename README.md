...
* 必要情報を入力し送信ボタンをクリックする
#### 口コミを投稿する手順
* トップページから口コミを投稿したい店を検索する
* 検索結果画面で店舗名をクリックし店舗詳細ページにアクセスする
* 「口コミを投稿する」ボタンをクリックする
* フォームに口コミを入力し送信ボタンをクリックする
...
## 実装機能の特徴
#### お店を検索する機能
* 恋愛に特化した条件検索ができるように実装<br>（利用シーンから探す場合…「初デート」「記念日」「彼女の誕生日」「合コン」など）<br>実装動画…<https://youtu.be/t41A9hI6VoA>
...
#### 口コミ投稿&閲覧機能
* 各店舗の口コミ一覧ページを実装<br>実装動画…<https://youtu.be/0W8mbbfkd5w>
...
## ER図
<img width="300" alt="gourmet-app-ER" src="https://user-images.githubusercontent.com/68183520/92640509-5b9cf880-f318-11ea-86e9-0ddacd524ae3.png">

## ローカルでの動作方法
`git clone https://github.com/koumake/gourmet-app`
`bundle install`
`yarn install`
`rails db:create`
`rails db:migrate`
